...
const messageBody = `(If you have not used zoom before please join the meeting at least 15 minutes early because it may have you download and install some software.)
...
module.exports = { messages, messageBody };
